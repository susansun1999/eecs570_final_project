...
# DVE full session
# Saved on Wed Mar 3 11:09:27 2021
# Designs open: 1
...
#<Session mode="Full" path="/afs/umich.edu/user/z/w/zwtao/Documents/eecs570_final_project/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{60 66} {1595 763}}
...
gui_set_env SIMSETUP::SIMEXE {/afs/umich.edu/user/z/w/zwtao/Documents/eecs570_final_project/dve}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/afs/umich.edu/user/z/w/zwtao/Documents/eecs570_final_project/dve}] } {
gui_sim_run Ucli -exe dve -args {-ucligui +vc +define+ +memcbk} -dir /afs/umich.edu/user/z/w/zwtao/Documents/eecs570_final_project -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_3" { common_test.myCnter.counter common_test.myCnter.clk common_test.myCnter.reset }
...
gui_list_select -id ${Wave.1} {common_test.myCnter.counter }
