...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{1 38} {1536 735}}
...
catch {gui_list_expand -id ${Hier.1} common_test}
catch {gui_list_select -id ${Hier.1} {common_test.myCnter}}
